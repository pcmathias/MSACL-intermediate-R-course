...
base_load_nofactors <- read.csv( , stringsAsFactors = )
...
**Time to read with base:** `r system.time(base_load <- read.csv(here("class_data", "2017-01-06.csv")))`

**Time to read with readr:** `r system.time(readr_load <- read_csv(here("class_data", "2017-01-06.csv")))`
