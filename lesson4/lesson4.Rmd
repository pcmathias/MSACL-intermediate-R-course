...
```{r}
samples_jan_messy <- read_csv(here::here("data", "2017-01-06-messy.csv"))
...
The "2017-01-06-batch-messy.csv" file is related to the "2017-01-06.xlsx" batch file you have worked with before. Unfortunately, it is not set up to have a single observation per row. There are two problems that need to be solved:
...
```{r tidyr_exercise}
batch_jan_messy <- read_csv(here::here())
