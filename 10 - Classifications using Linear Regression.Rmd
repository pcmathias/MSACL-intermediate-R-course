...
exp(coef(mod_glm))
# Now we can say that for a one unit increase in SCr, the odds of being in group CKD3b (vs in CKD2) increase by a factor of 1.40
...
```{r}
ckd_test$stage_pred<- ifelse(ckd_test$stage_prob > 0.65, "CKD3b", "CKD2")
mean(ckd_test$stage_pred == ckd_test$stage) #0.92
```
