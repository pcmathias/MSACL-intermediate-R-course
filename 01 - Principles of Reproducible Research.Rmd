...
10. Delete the directory you created using the `dir_delete()` function. Learn more about how to use the function by reviewing the documentation: `?dir_delete`. (Base equivalent: `unlink()` + additional arguments)
...
Go ahead and close out the RStudio window with your "sample-project-structure" by clicking on the arrow next to the project name and selecting "Close Project".
