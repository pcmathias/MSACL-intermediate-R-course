...
"msacl-201-project" project. Refer to the top right of the window
...
`read_csv(here("file.csv"))` and it could be run by any who you share
the project with.
...
![One library rules them all. Source: https://kevinushey-2020-rstudio-conf.netlify.app/slides.html](../assets/shared-library.svg)
...
![One library per package. Source: https://kevinushey-2020-rstudio-conf.netlify.app/slides.html](../assets/project-library.svg)
