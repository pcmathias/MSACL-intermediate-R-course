...
Now that you're warmed up with navigating through directories using R, let's use functionality that's built into RStudio to make our project-oriented lives easier. To enter this brave new world of project directories, consider making home for your projects in a specific folder by running the code below. You may want to go back to your **Preferences** menu and set your *Default working directory* to the projects directory. (Alternately, if you already have a directory that's a home for your projects, set your working directory there.)
