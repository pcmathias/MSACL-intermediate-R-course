...
- figures, documents, other useful directories
- here package

### Name all files (and variables) to reflect their content or function

- file names should be intelligible to others
- avoid sequential naming (easier if using version control)
- adopt style conventions (preview of next section)

## Adopt a style convention for coding

- want others to read code, or to be able to come back and quickly understand
- style guides available: Google R style guide, tidyverse style guide
- styler and lintr packages help conform to style guide

## Enforce reproducibility for packages
